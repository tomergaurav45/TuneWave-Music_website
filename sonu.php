...
<head>
    ...
    <style>
        header .song_side{
         background-image: url('sonu_bg.png');
...
<body>
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Sonu Nigam</h1>
                <p>Sonu Nigam (born 30 July 1973) is an Indian playback singer, music director, dubbing artist and actor.[3] Nigam is a recipient of Padma Shri, India's fourth-highest civilian award. Nigam sings predominantly in Hindi and Kannada language films but has also sung in Bengali, Marathi, Telugu, Tamil, Odia, Bhojpuri, Gujarati </p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/sonu/1.jpg" alt="" id="poster_master_play">
            <h5 id="title"> Aisa Deewana
