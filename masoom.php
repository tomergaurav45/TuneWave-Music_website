...
<head>
    ...
    <title>Masoom Sharma</title>

    <style>
        header .song_side{
         background-image: url('masoom_bg.png');
...
<body>
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Masoom Sharma</h1>
                <p>Aarya Masoom Sharma, known as Masoom Sharma, is a singer, Lyricist, and composer from The Haryanvi Entertainment Industry. He was born on March 27, 1991, in Brahmanwas, Jind District, Haryana, India, and completed his education at Government Public School.</p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/masoom/1.jpg" alt="" id="poster_master_play">
            <h5 id="title">Badnam Gabru
