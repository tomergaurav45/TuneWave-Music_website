...
<head>
    ...
    <title>Darhan Raval</title>

    <style>
        header .song_side{
         background-image: url('darshan_bg.png');
...
<body>
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Darshan Raval</h1>
                <p>Darshan Raval was born on 18 October 1994 in Ahmedabad, Gujarat into a Gujarati Hindu family.[3] His father Rajendra Raval is a freelance writer In 2014, Raval began his career by participating in the reality show "India's Raw Star," where he was the first runner-up</p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/darshan/1.jpg" alt="" id="poster_master_play">
            <h5 id="title">Hawa Banke
