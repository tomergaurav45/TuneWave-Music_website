...
<head>
    ...
    <style>
        header .song_side{
         background-image: url('lata_bg.png');
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <p>Lata Mangeshkar  born Hema Mangeshkar; 28 September 1929 - 6 February 2022 was an Indian playback singer and occasional music composer. She is considered to be one of the greatest and most influential singers of the Indian subcontinent.[9][10][11][12] Her voice was one of the unifying elements of the people of India, Sri Lanka, Pakistan, Bangladesh, and Nepal. </p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/lata/1.jpg" alt="" id="poster_master_play">
            <h5 id="title"> Aankhein Khuli
