...
<head>
    ...
    <style>
        header .song_side{
         background-image: url('badshah_bg.png');
...
<body>
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Badshah</h1>
                <p>Aditya Prateek Singh[a] (born 19 November 1984), known professionally as Badshah (also stylised as badboyshah), is an Indian rapper, singer, songwriter, music producer and entrepreneur. Badshah began his career as an underground English rapper under the stage name "Cool Equal".</p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/badshah/1.jpg" alt="" id="poster_master_play">
            <h5 id="title">Akkad Bakkad
