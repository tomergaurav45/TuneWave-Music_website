...
<head>
    ...
    <title>Gulzaar Chhaniwala</title>

    <style>
        header .song_side{
         background-image: url('gulzar_bg.png');
...
<body>
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Gulzaar Chhaniwala</h1>
                <p>Gulzaar Chhaniwala's actual name is Ashish Sharma.[1] He was born and brought up in Bhiwani, Haryana. He started his singing career with the Haryanavi song Kasoote in the year 2018. Looking at the success of his song, he came up with the second installment of this song titled Kasoote-2. </p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/gulzar/1.jpg" alt="" id="poster_master_play">
            <h5 id="title"> Filter Shot
