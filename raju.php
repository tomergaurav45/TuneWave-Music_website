...
<head>
    ...
    <title>Raju Punjabi</title>

    <style>
        header .song_side{
         background-image: url('raju_bg.png');
...
<body>
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Raju Punjabi</h1>
                <p>Raju Punjabi was an Indian singer. He was known for singing fun pop and traditional Haryanvi songs. His most popular Haryanvi songs include Desi Desi Na Bolya Kar,and  He wanted to become a singer since childhood. He started performing on stage during his college days. </p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/raju/1.jpg" alt="" id="poster_master_play">
            <h5 id="title"> Desi Desi
