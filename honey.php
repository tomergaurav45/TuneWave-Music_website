...
<head>
    ...
    <style>
        header .song_side{
         background-image: url('honey_bg.png');
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <p>Hirdesh "Honey" Singh (born 15 March 1983), known professionally as Yo Yo Honey Singh, is a music producer, singer and actor. He commenced his career as a hip-hop music producer in 2003, working as a session</p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/honey/1.jpg" alt="" id="poster_master_play">
            <h5 id="title"> Angreji Beat
