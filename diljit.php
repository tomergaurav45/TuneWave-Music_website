...
<head>
    ...
    <title>Diljit Dosanjh</title>

    <style>
        header .song_side{
         background-image: url('diljit_bg.png');
...
<body>
    <header>
        ...
        <div class="master_play">
            ...
            <img src="img/diljit/1.jpg" alt="" id="poster_master_play">
            <h5 id="title"> 5 Taara
