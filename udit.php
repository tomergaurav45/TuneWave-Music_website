...
<head>
    ...
    <style>
        header .song_side{
         background-image: url('udit_bg.png');
...
<body>
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Udit Narayan</h1>
                <p>Udit Narayan Jha (born 1 December 1955) is an Indian playback singer[3] whose songs have been featured mainly in Hindi films. He has also sung in various other languages including Telugu, Kannada, Tamil, Bengali, Sindhi, Odia, Bhojpuri, Nepali, Malayalam, Assamese, Bagheli and Maithili</p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/udit/1.jpg" alt="" id="poster_master_play">
            <h5 id="title">Andekhi Anjaani
