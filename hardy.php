...
<head>
    ...
    <title>Harrdy Sandhu</title>

    <style>
        header .song_side{
         background-image: url('hardy_bg.png');
...
<body>
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Harrdy Sandhu</h1>
                <p>Hardavinder Singh Sandhu (born 6 September 1986) is an Indian singer, actor and former cricketer who works in Punjabi and Hindi films.[1][2] His first song was Tequilla Shot, and he gained popularity with Soch (2013) and Joker (2014), </p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/hardy/1.jpg" alt="" id="poster_master_play">
            <h5 id="title"> Hornn Blow
