...
<head>
    ...
    <title>Jubin Nautiyal</title>

    <style>
        header .song_side{
         background-image: url('jubin_bg.png');
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <p>Jubin Nautiyal (born 14 June 1989) is an Indian playback singer and live performer. In June 2022, he won the IIFA award for "Playback Singer (Male)" for the song "Raataan Lambiyan." He was awarded Upcoming Male Vocalist of the Year at 8th Mirchi Music Awards for his song "Zindagi Kuch Toh Bata (Reprise)" from Bajrangi Bhaijaan..</p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/jubin/1.jpg" alt="" id="poster_master_play">
            <h5 id="title">Barsaat Ki Dhun
